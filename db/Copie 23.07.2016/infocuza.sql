...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 23, 2016 at 02:28 PM
...
(000001, '2016-06-01', 'Siruri de caractere', 'Sirurile de caractere reprezinta, practic, un vector ce retine codul ASCII al fiecarui caracter. Aceasta structura este una dintre cele mai folosite si utile in domeniul informaticii.', 1256, 110, 'Lectie'),
(000002, '2015-06-05', 'Siruri de caractere', 'Sirurile de caractere reprezinta, practic, un vector ce retine codul ASCII al fiecarui caracter. Aceasta structura este una dintre cele mai folosite si utile in domeniul informaticii.', 1599, 124, 'Test'),
...
(000002, 'PAS', 'Ce reprezinta sirurile de caractere(string-uri)?', 'a:3:{i:0;s:46:"vectori ce retin codul ASCII ale caracterelor;";i:1;s:38:"tip de date, independent de celelalte;";i:2;s:47:"vector ce retine codul UNICODE al caracterelor.";}', 'Ce biblioteca este necesara a fi utilizata cand se folosesc string-urile?', 'a:3:{i:0;s:71:"limbajul Pascal nu necesita o biblioteca pentru a implemeta string-uri;";i:1;s:10:"iostream.h";i:2;s:8:"string.h";}', 'Citirea si scrierea string-urilor se face cu:', 'a:3:{i:0;s:46:"vectori ce retin codul ASCII ale caracterelor;";i:1;s:38:"tip de date, independent de celelalte;";i:2;s:47:"vector ce retine codul UNICODE al caracterelor.";}', 'La ce este folosita functia length()?', 'a:3:{i:0;s:46:"vectori ce retin codul ASCII ale caracterelor;";i:1;s:38:"tip de date, independent de celelalte;";i:2;s:47:"vector ce retine codul UNICODE al caracterelor.";}', 'La ce este folosita functia copy()?', 'a:3:{i:0;s:25:"copierea dintr-un string;";i:1;s:29:"concatenarea unor string-uri;";i:2;s:29:"aflarea lungimii unui string.";}', 'Ce se va afisa în urma executarii urmatoarei secvente de instructiuni?', '<p><code>s:="Primavara";</code><br> <code>for i:=1 to 3 do</code><br> <code>delete(s,2,1);</code><br> <code>writeln(a);</code><br></p>', 'Ce se va afisa în urma executarii urmatoarei secvente de instructiuni?', '<p><code>x:="Mama";</code><br> <code>y:="Macara";</code><br> <code>if (x&gt;y) then writeln(x)</code><br> <code>else if (x=y) then writeln("Incorect")</code><br> <code>else writeln(y);</code><br></p>', 'Ce se va afisa în urma executarii urmatoarei secvente de instructiuni?', '<p><code>s:="MacarA";</code><br> <code>x:="";</code><br> <code>for i:=1 to 6 do begin</code><br> <code>x:=s[i];</code><br> <code>s[i]:=s[7-i];</code><br> <code>s[7-i]:=x;</code><br> <code>end;</code><br> <code>writeln(s);</code><br></p>', 'Sa se afiseze toate prefixee unui cuvant.', '<p><code>var cuv:string;</code> <code>n,i:integer;</code> <code>begin</code> <code>write("Cuvantul este: ");</code> <code>readln(cuv);</code> <code class="droppable1 ui-droppable"></code> <code>for i:= 1 to n do</code> <code class="droppable2 ui-droppable"></code> <code>readln;</code> <code>end.</code></p>', '<p><code class="ui-draggable ui-draggable-handle">n:=length(cuv);</code> <code class="ui-draggable ui-draggable-handle">n:=cuv.lenght();</code> <code class="ui-draggable ui-draggable-handle">writeln(copy(cuv,1,i));</code> <code class="ui-draggable ui-draggable-handle">writeln(delete(cuv,1,i);</code></p>', '["1","1","1","2","1","Pavara","","AracaM","n:=length(cuv);","writeln(copy(cuv,1,i));"]'),
(000002, 'CPP', 'Ce reprezinta sirurile de caractere(string-uri)?', 'a:3:{i:0;s:46:"vectori ce retin codul ASCII ale caracterelor;";i:1;s:38:"tip de date, independent de celelalte;";i:2;s:47:"vector ce retine codul UNICODE al caracterelor.";}', 'Ce biblioteca este necesara a fi utilizata cand se folosesc string-urile?', 'a:3:{i:0;s:9:"string.h;";i:1;s:11:"iostream.h;";i:2;s:7:"math.h.";}', 'Citirea si scrierea string-urilor se face cu:', 'a:3:{i:0;s:46:"vectori ce retin codul ASCII ale caracterelor;";i:1;s:38:"tip de date, independent de celelalte;";i:2;s:47:"vector ce retine codul UNICODE al caracterelor.";}', 'La ce este folosita functia strlen?', 'a:3:{i:0;s:46:"vectori ce retin codul ASCII ale caracterelor;";i:1;s:38:"tip de date, independent de celelalte;";i:2;s:47:"vector ce retine codul UNICODE al caracterelor.";}', 'La ce este folosita functia strcpy?', 'a:3:{i:0;s:25:"copierea dintr-un string;";i:1;s:29:"concatenarea unor string-uri;";i:2;s:29:"aflarea lungimii unui string.";}', 'Ce se va afisa în urma executarii urmatoarei secvente de instructiuni?', '<p><code>a = "Primavara";</code><br> <code>for (int i=l;i&lt;=3;i++) strcpy(a+1,a+2);</code><br> <code>cout &lt;&lt; a;</code><br></p>', 'Ce se va afisa în urma executarii urmatoarei secvente de instructiuni?', '<p><code>x = "Mama";</code><br> <code>y = "Macara";</code><br> <code>if (strcmp(x,y)&gt;0) then cout &lt;&lt; y</code><br> <code>else if (x=y) then cout &lt;&lt; "Incorect"</code><br> <code>else cout &lt;&lt; x;</code><br></p>', 'Ce se va afisa în urma executarii urmatoarei secvente de instructiuni?', '<p><code>s = "MacarA";</code><br> <code>for (i=0; i&lt;strlen(s)/2; i++){</code><br> <code>char x = s[i];</code><br> <code>s[i] = s[strlen(s)-i-1];</code><br> <code>s[strlen(s)-i-1] = x;</code><br> <code>}</code><br> <code>cout &lt;&lt; s;</code><br></p>', 'Sa se afiseze toate prefixele unui cuvant.', '<p><code>#include </code> <code>#include </code> <code>#include </code> <code>int main(){</code> <code>string cuv;</code> <code>int n,i;</code> <code>cout &lt;&lt; "Cuvantul este:";</code> <code>cin &gt;&gt; cuv;</code> <code class="droppable1 ui-droppable"></code> <code>for (i=0; i&lt;=n; i++){</code> <code class="droppable2 ui-droppable"></code> <code>cin &gt;&gt; endl;</code> <code>}</code></p>', '<p><code class="ui-draggable ui-draggable-handle">n:=length(cuv);</code> <code class="ui-draggable ui-draggable-handle">n = strlen(cuv);</code> <code class="ui-draggable ui-draggable-handle">writeln(copy(cuv,1,i));</code> <code class="ui-draggable ui-draggable-handle">cout &gt;&gt; strcpy(cuv,n,i);</code></p>', '["1","1","3","2","1","Pavara","Mama","AracaM","n = strlen(cuv);","cout >> strcpy(cuv,n,i);"]');
