<?php
	...
	// Queries
	$query = "UPDATE materiale SET date='$date', title='$title', description='$description' WHERE id='$id'";
	$result = mysqli_query($conn, $query);
	$query = "UPDATE teste SET intrebare_1='$intrebare_1', raspuns_1='$raspuns_1', intrebare_2='$intrebare_2', raspuns_2='$raspuns_2', intrebare_3='$intrebare_3', raspuns_3='$raspuns_3', intrebare_4='$intrebare_4', raspuns_4='$raspuns_4', intrebare_5='$intrebare_5', raspuns_5='$raspuns_5', output_1='$output_1', code_output_1='$code_output_1',  output_2='$output_2', code_output_2='$code_output_2', output_3='$output_3', code_output_3='$code_output_3', drag_enunt='$drag_enunt', drag_code='$drag_code', drag_var='$drag_var', correct='$correct' WHERE $id='$id' AND lang='$lang'";
	$result = mysqli_query($conn, $query);
